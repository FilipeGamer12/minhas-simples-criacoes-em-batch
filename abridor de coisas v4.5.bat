...
:novsimp
msg * Novidades: Adicao de 3 novos jogos e melhorias pequenas
goto inicio
...
echo.
echo Novidades:
echo 1- Adicao de 3 novos jogos, Rocket League, Heroes Generals WW2 e Ravenfield
echo 2- Pequenas melhorias de funionalidade e layout
echo.
...
cls
echo.
echo Teste para abrir jogos da Epic Games . . .
timeout /t 4 /NOBREAK
echo.
"C:\Program Files (x86)\Epic Games\"
"C:\Program Files (x86)\Epic Games\Launcher\Portal\Binaries\Win32\EpicGamesLauncher.exe"
